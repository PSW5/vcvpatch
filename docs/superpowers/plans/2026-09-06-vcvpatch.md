...
- [x] **Step 1: 建立 pyproject.toml 與 .gitignore**
...
- [x] **Step 3: 寫 conftest.py 與 test_model.py（失敗測試）**
...
- [x] **Step 1: 寫失敗測試 tests/test_archive.py**
...
- [x] **Step 1: 寫失敗測試 tests/test_library.py**
...
- [x] **Step 1: 寫失敗測試 tests/test_validate.py**
...
- [x] **Step 1: 寫失敗測試 tests/test_summary.py**
...
- [x] **Step 1: 寫失敗測試 tests/test_cli.py**
...
- [x] **Step 1: 寫失敗測試 tests/test_mcp.py**
...
- [x] **Step 1: 寫 scripts/roundtrip_check.py**
...
- [x] **Step 3: 驗收 2 — 用 vcv_create 產生 patch 並在 Rack 2 Pro 開啟**
...
- [x] **Step 4: 寫 LICENSE（MIT）、CLAUDE.md、README.md**
